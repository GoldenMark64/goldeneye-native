...
flat grey report now passes after issue #85's follow-up sanitizer fix. Records made before that fix
retain their original result and sanitizer hashes: they are not silently regraded, and replay under
the changed sanitizer refuses them just as it refuses a different harness.
